...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.refreshData_btn = QtWidgets.QPushButton(self.scrollAreaButtonBox_widget)
        self.refreshData_btn.setEnabled(False)
        self.refreshData_btn.setObjectName("refreshData_btn")
        self.horizontalLayout_3.addWidget(self.refreshData_btn)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1088, 536))
        ...
        self.xmlConvert_btn = QtWidgets.QPushButton(self.convert_widget)
        self.xmlConvert_btn.setEnabled(False)
        self.xmlConvert_btn.setObjectName("xmlConvert_btn")
        self.gridLayout_2.addWidget(self.xmlConvert_btn, 0, 1, 1, 1)
        self.xmlSummary_btn = QtWidgets.QPushButton(self.convert_widget)
        self.xmlSummary_btn.setEnabled(False)
        self.xmlSummary_btn.setObjectName("xmlSummary_btn")
        self.gridLayout_2.addWidget(self.xmlSummary_btn, 0, 0, 1, 1)
        ...
        self.functionDefinition_action = QtWidgets.QAction(MainWindow)
        self.functionDefinition_action.setEnabled(False)
        self.functionDefinition_action.setObjectName("functionDefinition_action")
        self.menuConverter.addSeparator()
        self.menuConverter.addAction(self.functionDefinition_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.refreshData_btn.setToolTip(_translate("MainWindow", "Filter and load xml teststep data based on config"))
        self.refreshData_btn.setStatusTip(_translate("MainWindow", "Filter and load xml teststep data based on config"))
        self.refreshData_btn.setWhatsThis(_translate("MainWindow", "Filter and load xml teststep data based on config"))
        self.refreshData_btn.setText(_translate("MainWindow", "Refresh"))
        ...
        self.xmlConvert_btn.setToolTip(_translate("MainWindow", "Convert all selected teststeps"))
        self.xmlConvert_btn.setStatusTip(_translate("MainWindow", "Convert all selected teststeps"))
        self.xmlConvert_btn.setWhatsThis(_translate("MainWindow", "Convert all selected teststeps"))
        self.xmlConvert_btn.setText(_translate("MainWindow", "Convert"))
        self.xmlSummary_btn.setToolTip(_translate("MainWindow", "Summary of selected teststeps for conversion"))
        self.xmlSummary_btn.setStatusTip(_translate("MainWindow", "Summary of selected teststeps for conversion"))
        self.xmlSummary_btn.setWhatsThis(_translate("MainWindow", "Summary of selected teststeps for conversion"))
        self.xmlSummary_btn.setText(_translate("MainWindow", "Summary"))
        ...
        self.functionDefinition_action.setText(_translate("MainWindow", "Function definitions"))
