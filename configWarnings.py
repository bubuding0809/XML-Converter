...
DUP_FUNCTION_NAMES_WARNINGS = 'There are duplicate function_name definitions in your config file, \
...
Ensure that all DD2.0 function library, name and parameters used are defined in the function library sheet'